...
if (len(sys.argv) != 2):
    sys.exit("Incorrect argument, please run as python3 postCDK.py deploy|destroy ")

# This variable gets replaced as per monitoring_cdk_stack.py#REGIONS_TO_MONITOR everytime cdk deploy/destroy kicks in
